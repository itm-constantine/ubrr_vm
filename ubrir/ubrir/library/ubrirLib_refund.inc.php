 ...
 * @version ubrirLib 1.5.4  $Id: ubrirLib_refund.inc.php 5776 2012-11-23 16:26:25Z dehn $
 * @author ubrir AG http://www.ubrir.com (integration@ubrir.com)
 *
 */
class ubrirLib_Refund extends ubrirLib_Abstract {
	...
	/**
	 * 
	 * Constructor for ubrirLib_Refund
	 * @param string $configKey
	 */
	public function __construct($configKey = '') {
		list($userId, $projectId, $apiKey) = explode(':', $configKey);
		$apiUrl = (getenv('refundApiUrl') != '') ? getenv('refundApiUrl') : 'https://www.ubrir.com/payment/refunds';
