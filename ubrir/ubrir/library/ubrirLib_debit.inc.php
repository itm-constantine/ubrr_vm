 ...
 * @version ubrirLib 1.5.4  $Id: ubrirLib_debit.inc.php 5989 2013-02-20 17:28:51Z niehoff $
 * @author ubrir AG http://www.ubrir.com (integration@ubrir.com)
 *
 */
class ubrirLib_Debit extends ubrirLib_Abstract {
	...
	/**
	 *
	 * Constructor for ubrirLib_Debit
	 * @param string $configKey
	 */
	public function __construct($configKey = '') {
		list($userId, $projectId, $apiKey) = explode(':', $configKey);
		$apiUrl = (getenv('debitApiUrl') != '') ? getenv('debitApiUrl') : 'https://www.ubrir.com/payment/debitpay/xml';
	...
	/**
	 * Project id
	 * Id of your ubrirlastschrift project
	 *
	 * @param int $id project id
	 * @return ubrirLib_Debit $this
	 */
