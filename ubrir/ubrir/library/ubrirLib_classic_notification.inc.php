...
/**
 * Instance of this class handles the callback of ubrir to notify about a status change, the classic way to do so
 *
 ...
 * @version ubrirLib 1.5.4  $Id: ubrirLib_classic_notification.inc.php 5809 2012-11-30 11:10:48Z rotsch $
 * @author ubrir AG http://www.ubrir.com (integration@ubrir.com)
 *
 */
class ubrirLib_ClassicNotification {
	...
	/**
	 *
	 * Constructor for ubrirLib_ClassicNotification
	 * @param int $userId
	 * @param int $projectId
