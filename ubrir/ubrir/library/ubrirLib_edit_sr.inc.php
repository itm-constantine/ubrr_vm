 ...
 *
 * eg: $confirmObj = new ubrirLib_EditSr('yourapikey');
 *
 ...
 * @version ubrirLib 1.5.4  $Id: ubrirLib_edit_sr.inc.php 4191 2012-05-21 14:53:26Z niehoff $
 * @author ubrir AG http://www.ubrir.com (integration@ubrir.com)
 *
 */
class ubrirLib_EditSr extends ubrirLib_Abstract {
	...
	/**
	 *
	 * Constructor for ubrirLib_EditSr
