...
require_once 'ubrirLib_classic_notification.inc.php';
/**
 * Setup a ubrirueberweisung.de session using the classic api
 ...
 *
 *
 * Called by the ubrirLib.php/ubrirLib_ideal_classic.php etc.
 * $ubrir->new ubrirLib_ubrirueberweisungClassic( $userid, $projectid, $password [, $hashfunction='sha1'] );
 * $ubrir->set...(); //set params for Hashcalculation
 * $ubrir->set...(); //set more params for Hashcalculation
 * $ubrir->getPaymentUrl();
 ...
 * @version ubrirLib 1.5.4  $Id: ubrirLib_ubrirueberweisung_classic.php 5773 2012-11-23 16:15:47Z dehn $
 * @author ubrir AG http://www.ubrir.com (integration@ubrir.com)
 *
 */
class ubrirLib_ubrirueberweisungClassic {
	...
	protected $_paymentUrl = 'https://www.ubrir.com/payment/start';
	...
	/**
	 * 
	 * Constructor for ubrirLib_ubrirueberweisungClassic
	 * @param int $userId
	 * @param int $projectId
	...
	protected function _getPaymentDomain() {
		return (getenv('ubrirPaymentUrl') != '') ? getenv('ubrirPaymentUrl') : $this->_paymentUrl;
	}
}
?>