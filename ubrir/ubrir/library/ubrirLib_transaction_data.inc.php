 ...
 *
 * eg: $transactionDataObj = new ubrirLib_TransactionData('yourapikey');
 *
 ...
 * @version ubrirLib 1.5.4  $Id: ubrirLib_transaction_data.inc.php 6103 2013-04-29 11:22:26Z dehn $
 * @author ubrir AG http://www.ubrir.com (integration@ubrir.com)
 *
 */
class ubrirLib_TransactionData extends ubrirLib_Abstract {
	...
	/**
	 *
	 * Constructor for ubrirLib_TransactionData
	...
	/**
	 *
	 * check if the transaction was a ubrirueberweisung
	 * @param int $i if you request multiple transactions at once you can set the number here
	 * @return boolean true|false
	 */
	public function isubrirueberweisung($i = 0) {
		if ($i < 0 || $i >= $this->_count) {
			return false;
		}
	...
	/**
	 *
	 * check if the transaction was a ubrirvorkasse
	 * @param int $i if you request multiple transactions at once you can set the number here
	 * @return boolean true|false
	 */
	public function isubrirvorkasse($i = 0) {
		if ($i < 0 || $i >= $this->_count) {
			return false;
		}
	...
	/**
	 *
	 * check if the transaction was a ubrirlastschrift
	 * @param int $i if you request multiple transactions at once you can set the number here
	 * @return boolean true|false
	 */
	public function isubrirlastschrift($i = 0) {
		if ($i < 0 || $i >= $this->_count) {
			return false;
		}
	...
	/**
	 *
	 * check if the transaction was a lastschrift by ubrir
	 * @param int $i if you request multiple transactions at once you can set the number here
	 * @return boolean true|false
	 */
	...
	/**
	 *
	 * check if the transaction was a ubrirrechnung
	 * @param int $i if you request multiple transactions at once you can set the number here
	 * @return boolean true|false
	 */
	public function isubrirrechnung($i = 0) {
		if($i < 0 || $i >= $this->_count) {
			return false;
		}
	...
	/**
	 * returns the reason the customer needs to use when paying for "Rechnung by ubrir"
