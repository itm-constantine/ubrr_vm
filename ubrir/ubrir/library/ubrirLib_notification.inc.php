 ...
 * use the transaction id to query the webservice for detailed data (ubrirLib_TransactionData)
 *
 * eg: $notificationObj = new ubrirLib_Notification();
 *
 ...
 * @version ubrirLib 1.5.4  $Id: ubrirLib_notification.inc.php 5773 2012-11-23 16:15:47Z dehn $
 * @author ubrir AG http://www.ubrir.com (integration@ubrir.com)
 *
 */
class ubrirLib_Notification extends ubrirLib_Abstract {
	...
	/**
	 * Constructor for ubrirLib_Notification
	 */
	 ...
	 * (non-PHPdoc)
	 * @see ubrirLib_Abstract::sendRequest()
	 */
