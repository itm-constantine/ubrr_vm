 ...
 *
 * example by usage:
 * $objMultipay = new ubrirLib_Multipays('my-API-KEY');
 * $objMultipay->setubrirueberweisung(); 					//OR setubrirrechnung(), setubrirvorkasse() etc.
 ...
 * @version ubrirLib 1.5.4  $Id: ubrirLib_multipay.inc.php 5773 2012-11-23 16:15:47Z dehn $
 * @author ubrir AG http://www.ubrir.com (integration@ubrir.com)
 *
 */
class ubrirLib_Multipay extends ubrirLib_Abstract {
	...
	public function __construct($configKey = '') {
		...
		$apiUrl = (getenv('ubrirApiUrl') != '') ? getenv('ubrirApiUrl') : 'https://api.ubrir.com/api/xml';
	 ...
	 * this will be used for ubrirvorkasse and ubrirrechnung
	 *
	 ...
	 * being sent to. Use ubrirLib_Notification and ubrirLib_TransactionData
	...
	/**
	 * add ubrirueberweisung as payment method
	 * @param double $amount this amount only applies to this payment method
	 * @return ubrirLib_Multipay $this
	 */
	public function setubrirueberweisung($amount = '') {
	 ...
	 * @return ubrirLib_Multipay $this
	 */
	public function setubrirueberweisungCustomerprotection($customerProtection = true) {
		$this->_paymentMethods[] = 'su';
	...
	/**
	 * add ubrirlastschrift as payment method
	 * @param double $amount this amount only applies to this payment method
	 * @return ubrirLib_Multipay $this
	 */
	public function setubrirlastschrift($amount = '') {
	 ...
	 * @return ubrirLib_Multipay $this
	 */
	public function setubrirlastschriftAddress($firstname, $lastname, $street, $streetNumber, $zipcode, $city, $salutation, $country = 'DE') {
	 ...
	 * @param string $country country code, only DE allowed at the moment
	 *
	 * @return ubrirLib_Multipay object
	 */
	...
	/**
	 * add ubrirrechnung as payment method
	 ...
	 * @return ubrirLib_Multipay object
	 */
	public function setubrirrechnung() {
	...
	/**
	 * add ubrirvorkasse as payment method
	 * @param double $amount this amount only applies to this payment method
	 *
	 * @return ubrirLib_Multipay objet
	 */
	public function setubrirvorkasse($amount = '') {
	 ...
	 * @return ubrirLib_Multipay $this
	 */
	public function setubrirvorkasseCustomerprotection($customerProtection = true) {
		$this->_paymentMethods[] = 'sv';
	 ...
	 * @return ubrirLib_Multipay $this
	 */
	public function setubrirrechnungCustomerId($arg) {
	 ...
	 * @return ubrirLib_Multipay $this
	 */
	public function setubrirrechnungOrderId($arg) {
	 ...
	 * @return ubrirLib_Multipay $this
	 */
	public function setubrirrechnungInvoiceAddress($firstname, $lastname, $street, $streetNumber, $zipcode, $city, $salutation, $country = 'DE', $nameAdditive = '', $streetAdditive = '', $companyName = '') {
	 ...
	 * @return ubrirLib_Multipay $this
	 */
	public function setubrirrechnungShippingAddress($firstname, $lastname, $street, $streetNumber, $zipcode, $city, $salutation, $country = 'DE', $nameAdditive = '', $streetAdditive = '', $companyName = '') {
	 ...
	 */
	public function addubrirrechnungItem($itemId, $productNumber, $title, $unitPrice, $productType = 0, $description = '', $quantity = 1, $tax = 19) {
	...
	/**
	 * 
	 * Setter for commenting Rechnung by ubrir
	 * @param string $comment
	 */
	public function setubrirrechungComment($comment) {
	 ...
	 * @return boolean
	 */
	public function removeubrirrechnungItem($itemId) {
		$i = 0;
	 ...
	 * @return boolean
	 */
	public function updateubrirrechnungItem($itemId, $quantity, $unitPrice) {
		$i = 0;
	 ...
	 * @param int $itemId
	 */
	public function getubrirrechnungItemAmount($itemId) {
		$i = 0;
	 ...
	 * @param string $arg
	 */
	public function setubrirrechnungTimeForPayment($arg) {
	 ...
	 * @param int $itemId
	 */
	public function getubrirrechnungItem($itemId) {
	 ...
	 */
	public function getubrirrechnungItems() {
	 ...
	 * Is ubrirüberweisung
	 */
	public function isubrirueberweisung() {
	...
	/**
	 * 
	 * Is vorkasse by ubrir
	 */
	public function isubrirvorkasse() {
	...
	/**
	 * 
	 * Check if it is a ubrirlastschrift
	 */
	public function isubrirlastschrift() {
	...
	/**
	 * 
	 * Is rechnung by ubrir
	 */
	public function isubrirrechnung() {
