 ...
 * @version ubrirLib 1.5.4  $Id: ubrirLib_http.inc.php 5773 2012-11-23 16:15:47Z dehn $
...
class ubrirLib_Http {
	...
	public function postCurl($data, $url = false, $headers = false) {
		...
		$headers[] = 'User-Agent: ubrirLib-php/'.ubrirLIB_VERSION.'-'.$this->connectionMethod;
